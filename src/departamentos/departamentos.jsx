...
import { getAllDepartamentos, getDepartamento , deleteDepartamento, PostDepartamento, PutDepartamento} from "../services/departamentos";
...
function Departamentos() {
    ...
    const onSaveCrear = async() => {
        await PostDepartamento(formData); // manda los datos al padre
        await fetchData()
        Cerrar();
    };
    //Modal Editar
    ...
    switch (componente) {
        case 'Tabla':
            return(
            <>
                <button onClick={()=>{setComponente('Nuevo')}}>Nuevo Departamento</button>
                <button onClick={async ()=>{await fetchData()}}>Ver Todos</button>
                <br />
                <br />
